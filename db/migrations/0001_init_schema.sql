-- redAI migration 0001_init_schema
-- Derived from db/001_reference_schema.sql lines 6-713 (all tables, indexes, deferred/added FK + CHECK constraints).
-- No BEGIN/COMMIT here: the migration runner wraps each file in a single transaction.
-- Target: PostgreSQL 16.13 (verified). SPEC_LOCK target major is 18 (see docs/implementation-decisions.md D04).
